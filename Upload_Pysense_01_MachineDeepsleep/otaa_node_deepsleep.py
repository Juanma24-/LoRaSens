...
#------------------------------------------------------------------------------#
    def send(self,data):
        ...
        """
        if machine.wake_reason() == machine.PIN_WAKE:                           #Si despierta tras deepsleep
            # Initialize LoRa in LORAWAN mode
            ...
            try:
                ...
                self.connect(binascii.unhexlify('0032140A05C8D228'),
...
if machine.wake_reason() == machine.RTC_WAKE:                                   #Si despierta tras deepsleep
    print('Woke from a deep sleep R:%d'%(machine.wake_reason()))
    ...
    print('- ' * 20)
    machine.deepsleep((300-ajuste)*1000)                                        #Dispositivo enviado a Deepsleep
    ...
    print("Data Sent, sleeping ...")
    print('- ' * 20)
    machine.deepsleep((300-ajuste)*1000)
